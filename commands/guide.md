...
| Review | `/beacon:inspect` | Tier 1–3 audit, scoring, jurisdiction-aware WCAG context | Decide the criteria that need human judgement — see the coverage table above |
