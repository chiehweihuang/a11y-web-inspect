...
const SCRIPTS = ['static-audit', 'generate-report', 'lighthouse-extract', 'lang-detect', 'auth-detect', 'pdf-detect', 'pdf-triage', 'quality-detect', 'focus-flow', 'pattern-runtime', 'tier2-audit', 'axe-results'];
